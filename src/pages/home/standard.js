...
<div class="post-profile">
  <nav id="profile-info">
    <!-- Aqui podem ir as informações de perfil -->
  </nav>
  
  <div id="post-new">
    <form id="post-form">
      <input type="text" id="post-text" placeholder="O que gostaria de compartilhar?" />
...
<footer class="footer">
  <div>
    <p class="footer">
      Copyright 2020 | 
      <a href="https://github.com/cbalieiro" target="_blank" rel="noopener noreferrer">Camila Oliveira</a>,
      <a href="https://github.com/rebecaCanesin" target="_blank" rel="noopener noreferrer">Rebeca Canesin</a> e
      <a href="https://github.com/ThWember" target="_blank" rel="noopener noreferrer">Thais Wemberlaine</a>
    </p>        
  </div>
</footer>
